...
namespace PSView
{
	...
	*/
	public __gc class CFriendlyName : public IComparable
	{
	protected:
		String *szName;
		DateTime dtDate;
	...
	public:
		...
		__property bool get_Modifiable();
		__property void set_Modifiable(bool value);
		__property String * get_FullPath();
		__property void set_FullPath(String *value);

		__property int get_Count();
		CFriendlyName *FriendlyName(int idx);
	};

	public __gc class CProcessViewer
	{
	public:
		CProcessViewer() {}
